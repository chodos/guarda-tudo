...
BeatPicker.prototype={dateInputNode:null,pickerNode:null,daysSimple:"D S T Q Q S S".split(" "),daysFull:[],monthsSimple:"Jan Fev Mar Abr Mai Jun Jul Ago Set Out Nov Dez".split(" "),monthsFull:"Janeiro Fevereiro Março Abril Maio Junho Julho Agosto Setembro Outubro Novembro Dezembro".split(" "),startDate:new Date,currentDate:new Date,dateFormat:{separator:"-",format:["YYYY","MM","DD"]},modules:{header:!0,footer:!0,daysOfTheWeek:!0,navBar:!0,today:!0,gotoDate:!0,icon:!0,clear:!0},selectionRule:{single:!0,
